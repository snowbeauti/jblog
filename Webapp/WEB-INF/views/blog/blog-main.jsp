		...
		<div id="content" class="clearfix">
			<div id="profilecate_area">
				<div id="profile">
					...
					<!-- 기본이미지 -->
					<img id="proImg" src="${pageContext.request.contextPath}/upload/${bvo.logoFile}">
					

					<div id="nick">${pMap.uvo.userName}(${pMap.uvo.id})님</div>
				</div>
				<div id="cate">
					<div class="text-left">
						<strong>카테고리</strong>
			...
			<div id="post_area">
				...
				<div id="postBox" class="clearfix">
						...
						<div id="postNick">${pMap.uvo.userName}(${pMap.uvo.id})님</div>
				</div>
				<!-- //postBox -->
